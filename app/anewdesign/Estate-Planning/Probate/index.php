	...
	<header>
		<div class="container">
			<div class="intro">
				...
				<p class="intro-links">
					<a href="#">living trusts</a><span> - </span>
					<a href="#">medicaid trusts</a><span> - </span>
					<a href="#">business succession</a>
				</p>
			</div>
		</div>
	</header>
		...
		<div class="container">
			<div class="row flex flex-nowrap">
				<div class="col-md-8 md-text-center">
					...
					<p class="section-text text-muted">&quot;Probate&quot; is a legal term referring to the court-supervised process of transferring property from the deceased to the living. Wyoming usually requires probate when an estate is worth more than $200,000. Probate disadvantages, such as its being public record, and alternatives are discussed further below and on their respective pages.</p>
					<p class="section-text text-muted">View our articles on &quot;<a href="#">How Does Probate Work?</a>&quot; and &quot;<a href="#">Probate Alternatives</a>&quot;. If you still have questions after browsing below then we encourage you to reach out and schedule a consultation.</p>
				</div>
				<div class="col-md-4 flex">
					<a href="#"><img src="/anewdesign/img/mark-pierce.jpg" class="img-circle img-thumbnail" alt="Mark Pierce" /></a>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row text-center">
				<div class="col-xs-12 col-md-10 col-md-offset-1 service">
					<a href="/anewdesign/Estate-Planning/">
						<img src="/anewdesign/img/services/estate.png" alt="Estate Planning" class="service-img img-centered" />
					</a>
					<h4 class="service-heading"><a href="/anewdesign/Estate-Planning/">Estate planning</a></h4>
				...
				<div class="col-xs-12 col-md-10 col-md-offset-1 service">
					...
					<h4 class="service-heading"><a href="/anewdesign/Asset-Protection/">Asset Protection Strategies</a></h4>
					...
					<blockquote class="service-blockquote">
						<h4 class="blockquote-heading"><i><a href="/anewdesign/Asset-Protection/Domestic-Trust/">Domestic Asset Protection Trusts (DAPT)</a></i></h4>
						<i>
						...
						<h4 class="blockquote-heading"><i><a href="/anewdesign/Asset-Protection/Medicaid-Trust/">Medicaid Asset Protection Trusts</a></i></h4>
						<i>
						...
						<h4 class="blockquote-heading"><i><a href="/anewdesign/Asset-Protection/Solo-401k-LLC/">Solo 401(K) LLCS</a></i></h4>
						<i>
				...
				<div class="col-xs-12 col-md-10 col-md-offset-1 service">
					...
					<h4 class="service-heading"><a href="/anewdesign/Wyoming/">Corporate Structures &amp; Strategies</a></h4>
					<p class="section-text text-muted service-text">
