...
<body id="page-top" class="index">
			...
			<div class="row text-center">
				...
				<div class="col-xs-12 col-md-10 col-md-offset-1 service">
					...
					<blockquote class="service-blockquote">
						<h4 class="blockquote-heading"><i><a href="Asset-Protection/Domestic-Trust/">Domestic Asset Protection Trusts (DAPT)</a></i></h4>
						<i>
						...
						<h4 class="blockquote-heading"><i><a href="Asset-Protection/Medicaid-Trust/">Medicaid Asset Protection Trusts</a></i></h4>
						<i>
						...
						<h4 class="blockquote-heading"><i><a href="Asset-Protection/Solo-401k-LLC/">Solo 401(K) LLCS</a></i></h4>
						<i>
				...
				<div class="col-xs-12 col-md-10 col-md-offset-1 service">
					...
					<ul class="text-muted service-list">
						<li>
							<a href="Wyoming/WY-LLCs/">Wyoming LLCs</a>: Learn about LLCs, including their unique <a href="#"><i>benefits</i></a> and <a href="#"><i>privacy</i></a>. We can assist no matter where you or your business are located.
						</li>
						<li>
							<a href="Wyoming/WY-C-Corporation/">Wyoming Corporations</a>: Learn about corporations, including their <a href="#"><i>benefits</i></a> and <a href="#"><i>privacy</i></a>. Just as with LLCs, we can assist regardless of where you live or your business is located. 
						</li>
						<li>
							<a href="Wyoming/Virtual-Office/">Virtual Offices</a>: We provide a full suite of services. From lease, to phones and mail forwarding.
						</li>
						<li>
							<a href="Wyoming/RegisteredAgent/">Registered Agent Services</a>: The professionalism of a law firm, at a fraction of the usual price.
						</li>
	...
	<!-- Contact Section -->
	<?php include_once('includes/contact/index.php'); ?>

	<!-- Footer -->
	<?php include_once('includes/footer/index.php'); ?>
	
	<!-- Back To Top -->
	<?php include_once('includes/back-to-top/index.php'); ?>

	<!-- JS libs -->
	<?php include_once('includes/js-libs/index.php'); ?>

	<!-- Custom js -->
	<?php include_once('includes/custom-js/index.php'); ?>
